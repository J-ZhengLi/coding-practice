-- Add source column to track exercise origin (scraped vs ai_generated)
ALTER TABLE exercises ADD COLUMN source TEXT NOT NULL DEFAULT 'scraped';

-- Make material_id nullable for AI-generated exercises that don't come from scraped materials
...
CREATE TABLE exercises_new (
    ...
    source TEXT NOT NULL DEFAULT 'scraped' CHECK(source IN ('scraped', 'ai_generated')),
...
SELECT id, material_id, title, description, language, difficulty, todo_comment, original_code, exercise_code, concept, start_line, end_line, 'scraped', generated_at
FROM exercises;
